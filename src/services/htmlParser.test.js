...
describe('Parser', () => {
    ...
    const TextMultiline = ({children}) => (<div data-testid="multiline">{children}</div >);
    ...
    test('should replace text', () => {
     ...
     test('should replace multiline', () => {
         ...
         const Component = htmlParser.parser(origin);
         const wrapper = shallow(Component);
         expect(wrapper.html()).toBe('<div><div data-testid="multiline"><p>1</p><p>2</p></div></div>');
    });
     ...
     test('should replace ul', () => {
         ...
         const Component = htmlParser.parser(origin);
         const wrapper = shallow(Component);
         expect(wrapper.html()).toBe('<div><div data-testid="multiline"><li>hello</li><li>world!</li></div></div>');
    });

    test('should replace img', () => {
        const Component = htmlParser.parser('<img src="photo.jpg">');
        const wrapper = shallow(Component);
        expect(wrapper.html()).toBe('<div><div data-testid="image">photo.jpg</div></div>');
    });

    test('should replace img & paragraphs', () => {
        const Component = htmlParser.parser('<div class="wrapper"><div class="image"><img src="https://source.unsplash.com/random" width="500"></div><div class="content"><h2>hola mundo</h2><p>lorem</p><p>lorem</p></div></div>');
        const wrapper = shallow(Component);
        expect(wrapper.html()).toBe('<div><div class="wrapper"><div class="image"><div data-testid="image">https://source.unsplash.com/random</div></div><div class="content"><div data-testid="line">hola mundo</div><div data-testid="line">lorem</div><div data-testid="line">lorem</div></div></div></div>');
    });
